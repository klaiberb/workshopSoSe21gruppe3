...
$klasse->renderLabel("Dokumentart");
$klasse->render("Dokumentart");
$klasse->renderLabel("Datei_upload");
$klasse->render("Datei_upload");
$klasse->renderLabel("Datei_path");
$klasse->render("Datei_path");
$klasse->renderLabel("Datei_title");
$klasse->render("Datei_title");
...
?>
<form method="post" action="?task=Dokument_handle_Impfpatient&id=<?=$klasse->id?>" data-ajax="false">
<button type="submit" name="auswählen" id="auswählen" class="ui-btn ui-icon-bullets ui-btn-icon-left">Auswählen</button>
</form>
<a href="?task=Impfpatient_new&Dokument=<?=$klasse->id?>" data-ajax="false" data-role="button"  class="ui-btn ui-btn-b ui-icon-plus ui-btn-icon-left">Neuanlegen</a>
</div>
</div>
<th></th>
</div>
