...
$dest = "../workshopSoSe21gruppe3lim/speicherstände/workshopSoSe21gruppe3";
...
$directory = realpath("../workshopSoSe21gruppe3lim/speicherstände/workshopSoSe21gruppe3");
$options = array("remove_path" => $directory);
$zip->addPattern("/\.(?:json)$/", $directory, $options);
$zip->close();
}
//löscht alle existenten Export-Jsons 
array_map("unlink", glob("../workshopSoSe21gruppe3lim/speicherstände/workshopSoSe21gruppe3/*.json"));
}

//Bilder-Teil Export
if($_POST['Bilder'] == "1"){
try{
            $images_directory="../workshopSoSe21gruppe3lim/images";
...
if($_POST['Dateien'] == "1"){
try{
            $files_directory="../workshopSoSe21gruppe3lim/files";
