...
<?php }elseif($case=="headerMenu"){ ?>
<a href="<?=$item['url']?>" data-role="button" data-mini="true" data-icon="<?=$item['icon']?>" class="ui-link ui-btn ui-icon-<?=$item['icon']?> ui-btn-icon-left ui-shadow ui-corner-all ui-mini"><?=$item['label']?></a>
<?php }} ?>
